...
export async function createPayment(plan: Plan, ref: string, trial: boolean = false): Promise<any> {
    return await sendApiRequest("POST", "payment/create?ref=" + ref, true, {plan: plan, trial: trial})
}
