        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Feature 4</h3>
                    <p className="text-gray-500 dark:text-gray-400">
                        Feature 4
                    </p>
                </div>
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Feature 5</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Feature 6</h3>
