...
export default function Pricing() {
  ...
  async function subscriptionHandle(plan: string, trial: boolean = false, withBuyItNowDiscount: boolean = false) {
    try {
        // rewardful
        ...
        if (user?.dbuser.plan != "free") {
            ...
            var response = await createPayment(plan as Plan, refId, trial, withBuyItNowDiscount);
        ...
        return (<>
            <div className="flex items-center mx-auto">
                <button
                    ...
                    className="text-white mr-2  dark:focus:ring-primary-900 bg-gray-600 hover:bg-gray-400 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white "
                ...
                <button
                    ...
                    className="text-white bg-primary-600 hover:bg-green-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900"
                    disabled={user?.dbuser.plan == plan}
                >
                    Buy Now (20% Off)
                </button>
    ...
    <section id="pricing" className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                ...
                <div className="mx-auto flex justify-center items-baseline my-4 dark:bg-purple-500 border-dashed border-2 max-w-md rounded-md ">
                    <span className="mr-2 text-2xl font-extrabold">USE CODE</span>
                    <span className="mr-2 text-2xl font-extralight">BETARELEASE</span>
                    <span className="mr-2 text-2xl font-extrabold">10% OFF</span>
                    </div>
            </div>

            <div className="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
                <div className="px-12 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:py-8 dark:bg-gray-800 dark:text-white">
                ...
                <div className="px-12 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-primary-700 shadow dark:border-primary-600 xl:py-8 dark:bg-gray-800 dark:text-white shadow-md shadow-primary-700">
