...
export default function Pricing() {
  ...
  return (
    <section className="py-20 dark:text-gray-100 bg-gray-900">
      <div className="container px-4 mx-auto ">
        <div className="max-w-2xl mx-auto mb-16 text-center">
          <span className="font-bold tracking-wider uppercase dark:text-blue-500">
            Pricing
          </span>
        ...
        <div className="flex flex-wrap items-stretch -mx-4">
          <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-800">
              ...
              <ul className="flex-1 mb-6 dark:text-gray-400">
                <li className="flex mb-2 space-x-2">
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="flex-shrink-0 w-6 h-6 dark:text-blue-500"
                  >
                    <path
                      fillRule="evenodd"
              ...
              <button
                type="button"
                className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded dark:bg-blue-500 dark:text-gray-800"
          ...
          <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-blue-500 dark:text-gray-900">
              <div className="space-y-2">
              ...
              <button
                ...
                className="inline-block w-full px-5 py-3 font-bold tracking-wider text-center rounded dark:bg-gray-800 dark:text-blue-500"
              >
                Get Started
              </button>
            </div>
          ...
          <div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
            <div className="p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-800">
              <div className="space-y-2">
              ...
              <button
                ...
                className="inline-block w-full px-5 py-3 font-semibold tracking-wider text-center rounded dark:bg-blue-500 dark:text-gray-900"
              >
                Get Started
              </button>
            </div>
