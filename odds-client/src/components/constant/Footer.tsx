...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 py-5">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <Link href="/scraper/bets" className="hover:underline">Arbitrage Tool</Link>
                        </li>
                        <li>
                            <Link href="/scraper/ev" className="hover:underline">EV+ Tool</Link>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <Link href="https://discord.gg/YBgmG2gzne" className="hover:underline ">Discord</Link>
                        </li>
                        <li>
                            <Link href="" className="hover:underline ">SOCIAL1</Link>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <Link href="/legal/tos" className="hover:underline">Terms &amp; Conditions</Link>
                        </li>
                    </ul>
                </div>
            </div>
