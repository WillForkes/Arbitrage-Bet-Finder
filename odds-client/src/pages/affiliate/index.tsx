  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
                We&apos;re offering a 50% commission on all subscriptions. This beats the industry standard by a long shot.
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
                All our affiliates get lifetime access to our starter plan after referring just 1 user!
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
                We&apos;ve built a dashboard for our affiliates to track their progress and see how much they&apos;ve earned.
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
            Our affilaite program has no commitments, you can advertise your own affiliate link as you please!
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
            Joining our affiliate program is completely free, no fees or hidden costs!
            </p>
          </div>
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
        ...
        <div className="mx-auto max-w-screen-sm text-center pt-8">
        <Link href="https://discord.gg/YBgmG2gzne"
            className="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900"
            >
            Join the discord to signup!
        </Link>
    </div> 
      </div>
    </section>
