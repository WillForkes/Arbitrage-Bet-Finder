    ...
    <div className="page-offset-x py-8 bg-gray-900">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                <span className="text-xs bg-primary-700 rounded-full text-white px-4 py-1.5 mr-3">Learn</span> <span className="text-sm font-medium">Learn how our arbitrage tool works</span> 
